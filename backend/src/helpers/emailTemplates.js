...
function logoBlock() {
  return `
    <tr>
      <td style="padding:24px 32px;background:${OCEAN};">
        <span style="font-family:${FONT};font-size:20px;font-weight:800;letter-spacing:3px;color:#FFFFFF;">
          SAL<span style="color:${SAND};">.</span>DESK
        </span>
      </td>
    </tr>`;
}
