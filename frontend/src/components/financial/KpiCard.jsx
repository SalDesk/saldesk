...
export default function KpiCard({
  ...
  const deltaColor = isNeutral ? 'text-n-400' : isPositive ? 'text-green-600' : 'text-error';
  ...
  return (
    <div className="bg-white rounded-md border border-n-200 shadow-sm px-5 py-4">
      ...
      <p className="font-display font-bold text-2xl text-n-900 mb-1 leading-tight">{formatted}</p>
