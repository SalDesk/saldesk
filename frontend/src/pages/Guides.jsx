...
import { createAssignment, createCompositeAssignment } from '../services/assignmentService';
...
function AssignCompositeModal({ guide, guides, reservations, onClose, onDone }) {
  const [selected,   setSelected]   = useState('');
  ...
  return (
    <Modal open={!!guide} onClose={onClose} title="Atribuir equipa" size="sm"
      footer={
        <>
          <Button variant="secondary" onClick={onClose}>Cancelar</Button>
