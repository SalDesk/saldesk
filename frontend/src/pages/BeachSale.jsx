...
export default function BeachSale() {
  ...
  return (
    <div className="min-h-screen bg-n-50 flex flex-col max-w-md md:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto md:my-8 md:rounded-3xl md:shadow-xl md:border md:border-n-200 md:overflow-hidden">
      {/* Header */}
